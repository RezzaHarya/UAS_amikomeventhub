        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left border-collapse">
                ...
                <tbody class="divide-y border-t">
                            ...
                            <td class="px-8 py-6">
                                ...
                                @if($partner->logo_url)
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-16 h-10 bg-white border border-slate-200 rounded p-1 flex items-center justify-center">
                                            <img src="{{ asset('storage/' . $partner->logo_url) }}" alt="{{ $partner->name }}"
                                                class="max-w-full max-h-full object-contain">
                                        </div>
                                        <a href="{{ asset('storage/' . $partner->logo_url) }}" target="_blank"
                                            class="text-indigo-500 hover:underline text-xs font-bold">Lihat Penuh</a>
                                    </div>
                                @else
                                    <span class="text-slate-400 text-sm italic">Tidak ada logo</span>
                                @endif
                            </td>
                            <td class="px-8 py-6">
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-8 py-6 text-center text-slate-500 font-medium">Belum ada data partner.
                            </td>
                        </tr>
                    @endforelse
                </tbody>
